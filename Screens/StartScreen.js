...
>
  <View style={styles.buttonIconContainer}>
    ...
    <Text style={styles.bottomBarButtonText}>Home</Text>
        ...
        <TouchableOpacity style={styles.bottomBarButton}>
          <View style={styles.buttonIconContainer}>
            <Image source={require('../assets/love.png')} style={styles.buttonIcon} />
            <Text style={styles.bottomBarButtonText}>Favorite</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.bottomBarButton}>
          <View style={styles.buttonIconContainer}>
            <Image source={require('../assets/file.png')} style={styles.buttonIcon} />
            <Text style={styles.bottomBarButtonText}>History</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.bottomBarButton5}
